...
# Keyboard (and gamepad) controlling for CARLA. Please refer to client_example.py for a simpler
    ...
    def __init__(self):
        ...
        for i in range(joystick.get_numaxes()):
            ...
            if axis > -0.1 and axis < 0.1:
                axis = 0
            self.axis_states[i] = axis

        for i in range(joystick.get_numbuttons()):
            self.button_states[i] = joystick.get_button(i)

        hat = joystick.get_hat(0)
        self.button_states[self.ButtonMap.HAT_X] = hat[0]
        self.button_states[self.ButtonMap.HAT_Y] = hat[1]
...
class CarlaGame(object):
    ...
    def _on_loop(self):
        ...
        if pygame.joystick.get_count() > 0:
            control = self._get_gamepad_control()
        else:        
        ...
        if control is None:
            ...
            ap_control = measurements.player_measurements.autopilot_control
    ...
    def _get_gamepad_control(self):
        ...
        control.throttle = (gamepad.axis_states[GamepadManager.AxisMap.RT] + 1) / 2.0
        control.brake = (gamepad.axis_states[GamepadManager.AxisMap.LT] + 1) / 2.0
